...
class TravelOptions:
    ...
    def Process_User_Input(self):
        ...
        st.success(
            'Done! Please Check Your Email For Your Vacation Recommendations for ' + selected_city + '(Your Flights Are Listed Below) ')
        st.balloons()
...
class Flights():
    ...
    def find_flight(self, city):
        ...
        uri = 'mongodb+srv://tsafrir:TgbYhn12@cluster0.7c0gpqf.mongodb.net/?retryWrites=true&w=majority'
